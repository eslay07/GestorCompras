...
- Lectura de correos desde un archivo PST local configurable. Las tareas se buscan solo en la carpeta "Tareas_por_Reasignar" y se filtran por fecha. Los mensajes se ordenan por "ReceivedTime" para detener la búsqueda cuanto antes y se muestra el progreso (requiere pywin32 en Windows).
