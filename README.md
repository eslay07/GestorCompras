...
- Lectura de correos desde un archivo PST local configurable. Las tareas se buscan solo en la carpeta "Tareas_por_Reasignar" y se filtran por fecha para mayor velocidad (requiere pywin32 en Windows).
